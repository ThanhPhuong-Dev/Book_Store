...
function InfoGroup() {
  return (
    <div className="absolute bottom-0 bg-gradient-to-br from-green-400 via-green-500 to-green-600 h-28 flex items-center text-3xl text-white font-bold w-full px-8">
